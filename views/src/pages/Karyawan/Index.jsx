...
export default function Index() {
  ...
  const getData = () => {
    ...
    }/pegawai?page=${currentPage}&perpage=${"10"}`;
    if (onSearch) {
      setCurrentPage(1);
      url += `&search=${onSearch}`;
    }
  ...
  const handleHapus = (id) => {
    ...
    if (confirm(text) == true) {
      axios
      .delete(`${import.meta.env.VITE_BACKEND_API}/pegawai/${id}`,{})
      .then((res) => {
        getData()
        toastChange({
          id: "NotifdeletePegawai",
          content: {
            title: "Delete Data",
            description: "Delete Karyawan Successfuly",
  ...
  return (
    <div className="bg-white card">
      <div className="border-second card-header">
        <h3 className="mb-0 text-2xl font-semibold">Karyawan</h3>
